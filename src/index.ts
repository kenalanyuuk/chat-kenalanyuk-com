...
async function handleChatRequest(
	...
	try {
		...
		// Hanya izinkan pesan user/assistant dari frontend.
		// System prompt harus selalu dikendalikan oleh server agar tidak
		// dapat ditimpa oleh instruksi dari client.
		...
		// System prompt selalu dipasang oleh server.
		messages.unshift({
			role: "system",
